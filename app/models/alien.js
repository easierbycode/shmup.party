...
export class Alien extends Phaser.Sprite {
    ...
    constructor( game, x = game.world.randomX, y = game.world.randomY, key = 'alien' ) {
    ...
    update() {
        ...
        //  collision detection
        let alienTouchingPlayer  = this.game.physics.arcade.collide( this.game.players, this, this.game.baddieHitPlayer );
